  ...
  return (
    ...
    >
      ...
      <div className="flex gap-x-2 items-center justify-center mx-1 lg:w-[11%]">
        <button
          onClick={handleRead}
          className="bg-white hover:bg-[#f89f76] ring-[#f89f76] ring-1 hover:text-white text-[#f89f76] font-medium text-sm rounded-full p-3 "
        >
          <svg
        ...
        <button className="bg-white hover:bg-[#f89f76] ring-[#f89f76] ring-1 hover:text-white text-[#f89f76] font-medium text-sm rounded-full p-3 ">
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9l-3 3v-2.828l9.586-9.586z"
            />
          </svg>
        </button>
        <button
          onClick={handleDeletion}
          className="bg-white hover:bg-[#ff6464] ring-[#ff6464]  ring-1 hover:text-white text-[#ff6464] font-medium text-sm rounded-full p-3 "
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-4 w-4"
